    ...
    <tbody ref="tbodyRef">
      <tr>
        ...
        >
          <div>
            <span class="cell">
              {{ halfyearsMap[halfyears[cell.text]] }}
...
const halfyears = ref(['quarter1', 'quarter2'])
const halfyearsMap: any = {
  quarter1: '上半年',
  quarter2: '下半年',
}
...
const getCellStyle = (cell: MonthCell) => {
  ...
  const isToday = () => {
    return (
      ([0, 1, 2, 3, 4, 5].includes(curMonth) && month === 0) ||
      ([6, 7, 8, 9, 10, 11].includes(curMonth) && month === 1)
    )
  }
